...
class _EnhancedHealthDashboardState extends State<EnhancedHealthDashboard> {
  ...
  Widget _buildMediBotButton(BuildContext context) {
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(
              colors: [Color(0xFF8A4FFF), Color(0xFFE766FF)],
            ...
            boxShadow: [
              BoxShadow(
                  color: const Color(0xFF8A4FFF).withOpacity(0.5),
                  blurRadius: 20,
